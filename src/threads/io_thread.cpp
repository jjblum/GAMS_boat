...
// constructor
threads::io_thread::io_thread (std::shared_ptr<asio::serial_port> port_, Containers & containers_)
: port(port_), containers(containers_)
{
}

// destructor
threads::io_thread::~io_thread ()
{
}
 ...
 **/
void
threads::io_thread::init (knowledge::KnowledgeBase & knowledge)
{
